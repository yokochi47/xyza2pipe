...
int checknv(char filename[])
{
	...
	case NV_HEADERSIZE:
		break;
	default:
		swapbyte(sizeof(int), sizeof(int), buffer + j);
	...
	case 2:
		...
		if (k < dimension || obsfreq[0] < 1.0e+1 || obsfreq[1] < 1.0e+1 || obsfreq[0] > 1.0e+5 || obsfreq[1] > 1.0e+5
				|| spcenter[0] < -1.0e+2 || spcenter[1] < -1.0e+2 || spcenter[0] > 1.0e+3 || spcenter[1] > 1.0e+3
				|| spwidth[0] < 1.0e+2 || spwidth[1] < 1.0e+2 || spwidth[0] > 1.0e+6 || spwidth[1] > 1.0e+6) {
			swapbyte(sizeof(float), headersize, buffer);
	...
	case 3:
		...
		if (k < dimension || obsfreq[0] < 1.0e+1 || obsfreq[1] < 1.0e+1 || obsfreq[2] < 1.0e+1 || obsfreq[0] > 1.0e+5
				|| obsfreq[1] > 1.0e+5 || obsfreq[2] > 1.0e+5 || spcenter[0] < -1.0e+2 || spcenter[1] < -1.0e+2
				|| spcenter[2] < -1.0e+2 || spcenter[0] > 1.0e+3 || spcenter[1] > 1.0e+3 || spcenter[2] > 1.0e+3
				|| spwidth[0] < 1.0e+2 || spwidth[1] < 1.0e+2 || spwidth[2] < 1.0e+2 || spwidth[0] > 1.0e+6 || spwidth[1] > 1.0e+6
				|| spwidth[2] > 1.0e+6) {
			swapbyte(sizeof(float), headersize, buffer);
	...
	case 4:
		...
		if (k < dimension || obsfreq[0] < 1.0e+1 || obsfreq[1] < 1.0e+1 || obsfreq[2] < 1.0e+1 || obsfreq[3] < 1.0e+1
				|| obsfreq[0] > 1.0e+5 || obsfreq[1] > 1.0e+5 || obsfreq[2] > 1.0e+5 || obsfreq[3] > 1.0e+5
				|| spcenter[0] < -1.0e+2 || spcenter[1] < -1.0e+2 || spcenter[2] < -1.0e+2 || spcenter[3] < -1.0e+2
				|| spcenter[0] > 1.0e+3 || spcenter[1] > 1.0e+3 || spcenter[2] > 1.0e+3 || spcenter[3] > 1.0e+3
				|| spwidth[0] < 1.0e+2 || spwidth[1] < 1.0e+2 || spwidth[2] < 1.0e+2 || spwidth[3] < 1.0e+2 || spwidth[0] > 1.0e+6
				|| spwidth[1] > 1.0e+6 || spwidth[2] > 1.0e+6 || spwidth[3] > 1.0e+6) {
			swapbyte(sizeof(float), headersize, buffer);
