...
int pushvnmr2d(char monofile[], char pardir[], const char axis_option)
{
	...
	if (openvnmr2d(monofile, pardir, matrix2d) != 0)
		goto escape;

	sprintf(string, "rm -f %s", monofile);
	system(string);
...
int pushvnmr3d(char monofile[], char pardir[], const char axis_option)
{
	...
	if (openvnmr3d(monofile, pardir, matrix3d) != 0)
		goto escape;
...
int pushvnmr4d(char monofile[], char pardir[], const char axis_option)
{
	...
	if (openvnmr4d(monofile, pardir, matrix4d) != 0)
		goto escape;
